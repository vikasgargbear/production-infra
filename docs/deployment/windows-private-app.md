...
The Windows wrapper is a small, unsigned, sideloaded desktop shell for the live
...
Windows signing certificate for private testing.
...
2. Run `AASOPharma ERP_*_x64-setup.exe`.
