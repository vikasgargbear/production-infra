#!/usr/bin/env python3
"""Package the reviewed referenced-party cutover correction for Alembic."""
...
TARGET = ROOT / "backend/alembic/sql/20260830_0069_historical_referenced_party_cutover.sql"
...
def main() -> int:
    ...
    if not TARGET.is_file() or TARGET.read_text(encoding="utf-8") != rendered:
        raise SystemExit(
            "historical referenced-party cutover migration drifted; run with --write"
        )
    print("historical referenced-party cutover migration: current")
    return 0
