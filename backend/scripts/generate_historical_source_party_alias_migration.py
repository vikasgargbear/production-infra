#!/usr/bin/env python3
"""Package the reviewed source-party alias correction for Alembic."""
...
TARGET = ROOT / "backend/alembic/sql/20260830_0071_historical_source_party_alias.sql"
...
def main() -> int:
    ...
    if not TARGET.is_file() or TARGET.read_text(encoding="utf-8") != rendered:
        raise SystemExit("historical source-party alias migration drifted; run with --write")
    print("historical source-party alias migration: current")
    return 0
