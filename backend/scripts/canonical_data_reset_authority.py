...
def classify_relations(
    *,
    ...
    if len(reset_relations) != 119:
        raise ResetAuthorityError(
            f"reset relation count drifted: expected=119 observed={len(reset_relations)}"
        )
