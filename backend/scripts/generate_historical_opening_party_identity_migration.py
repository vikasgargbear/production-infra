#!/usr/bin/env python3
"""Package the reviewed opening party-identity correction for Alembic."""
...
TARGET = ROOT / "backend/alembic/sql/20260830_0070_historical_opening_party_identity.sql"
...
def main() -> int:
    ...
    if not TARGET.is_file() or TARGET.read_text(encoding="utf-8") != rendered:
        raise SystemExit("historical opening party-identity migration drifted; run with --write")
    print("historical opening party-identity migration: current")
    return 0
