...
SQL = ROOT / "backend/alembic/sql/20260827_0036_commercial_reversal_authority.sql"
REVISION = ROOT / "backend/alembic/versions/20260827_0036_commercial_reversal_authority.py"
...
def test_commercial_reversal_migration_is_linear_hash_bound_and_frozen():
    ...
    assert revision.revision == "20260827_0036"
    assert revision.down_revision == "20260827_0035"
