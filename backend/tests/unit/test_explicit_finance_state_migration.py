...
SQL = ROOT / "backend/alembic/sql/20260827_0035_explicit_finance_state.sql"
REVISION = ROOT / "backend/alembic/versions/20260827_0035_explicit_finance_state.py"
...
def test_explicit_finance_state_migration_is_linear_hash_bound_and_generated():
    ...
    assert revision.revision == "20260827_0035"
    assert revision.down_revision == "20260827_0034"
