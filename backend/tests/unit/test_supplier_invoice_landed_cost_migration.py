...
SQL = ROOT / "backend/alembic/sql/20260828_0040_supplier_invoice_landed_cost_authority.sql"
REVISION = ROOT / "backend/alembic/versions/20260828_0040_supplier_invoice_landed_cost_authority.py"
...
def test_migration_is_hash_bound_linear_and_generated_from_reviewed_sources():
    ...
    assert revision.revision == "20260828_0040"
    assert revision.down_revision == "20260828_0039"
