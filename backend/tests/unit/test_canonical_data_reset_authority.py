...
def test_reset_authority_classifies_exact_head_relation_sets() -> None:
    ...
    assert len(authority.canonical_relations) == 124
    ...
    assert len(authority.reset_relations) == 119
    ...
    assert authority.manifest()["expected_organization_relation_count"] == 108
