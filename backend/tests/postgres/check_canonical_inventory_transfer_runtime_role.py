...
def _seed(session: Session) -> None:
    ...
    session.execute(text("""
        ...
        SELECT :release_id,'hsn_sac_tax','transfer-runtime-v1','gstn','https://example.invalid/hsn',
        ...
        SELECT :org,:product,'TRANSFER-SKU','consumable','Transfer Fixture Product',:manufacturer,
