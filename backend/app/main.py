...
from .api.routes import stock_receive, enterprise_delivery_challan, inventory_batches, seed_data, create_user, simple_invoice
...
api.include_router(simple_invoice.router, tags=["Simple Invoice"])
