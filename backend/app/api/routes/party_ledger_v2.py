                ...
                query = """
                    WITH ledger_entries AS (
                        ...
                        SELECT 
                            ...
                            CONCAT('Invoice #', invoice_number, ' - ', COALESCE(narration, customer_name)) as description,
                        ...
                        SELECT 
                            ...
                            p.payment_number as reference,
                            CONCAT('Unallocated Payment #', p.payment_number, ' - ', COALESCE(p.narration, 'Advance')) as description,
                            0 as debit,
