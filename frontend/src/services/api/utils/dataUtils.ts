...
export const cleanData = (data: any): any => {
  ...
  if (data.pack_input || data.pack_quantity || data.pack_multiplier) {
    // console.log('Packing data clean:', { input: data.pack_input, quantity: data.pack_quantity });
  }
 ...
 */
export const formatDateTimeForAPI = (datetime: Date | string | null | undefined): string | null => {
