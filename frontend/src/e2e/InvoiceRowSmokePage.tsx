...
export default function InvoiceRowSmokePage() {
  const [items, setItems] = useState<ItemsTableItem[]>([{
    ...
    quantity: '1.000000', unit_price: '180.00', mrp: 220, discount_percent: '10',
    free_quantity: '2.000000', free_supply_tax_treatment: 'excluded_from_taxable_value',
    gst_percent: '5', line_total: '170.10',
  }]);
  return <main className="p-4">
    <h1>Invoice row layout test</h1>
    <ItemsTable compactBilling showFreeSupplyTaxTreatment preserveExactDecimals quantityDecimalPlaces={2} items={items}
