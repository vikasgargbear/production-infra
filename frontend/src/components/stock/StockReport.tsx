...
const StockReport = ({ open = true, onClose }) => {
  ...
  const renderSummaryReport = () => (
    <>
      {/* Summary Cards - Inline metric style */}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{formatCurrency(summaryData.totalValue)}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{summaryData.totalProducts}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{summaryData.lowStockItems}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{summaryData.expiringItems}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{summaryData.deadStock}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{summaryData.fastMoving}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        render: (row) => {
          ...
          return (
            <div>
              ...
              <div className={`text-sm ${daysToExpiry <= 0 ? 'text-red-600' :
                  ...
                  <div className="flex space-x-2">
                    {reportTypes.map(type => (
                      <button
                        ...
                        className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${reportType === type.value
