...
const LowStockAlert = ({ open = true, onClose }) => {
  ...
  const columns: any[] = [
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1 mt-1">
            {row.alert_types.map((alert, index) => (
              <span
                key={index}
                className={`px-1.5 py-0.5 text-xs font-medium rounded ${alert === 'Out of Stock' ? 'bg-red-100 text-red-800' :
    ...
    },
    {
      ...
      field: 'current_stock',
      render: (row) => (
        <div className={`font-medium ${row.current_stock === 0 ? 'text-red-600' :
    ...
    },
    {
      ...
      render: (row: any) => {
        ...
        return (
          <StatusBadge
            status={statusMap[row.priority] || row.priority.toUpperCase()}
          />
        );
      }
    }
          ...
          <div className="max-w-6xl mx-auto px-6 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border p-4 cursor-pointer transition-colors ${filterType === 'out-of-stock' ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
              ...
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border p-4 cursor-pointer transition-colors ${filterType === 'critical' ? 'border-orange-300 bg-orange-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border p-4 cursor-pointer transition-colors ${filterType === 'low-stock' ? 'border-yellow-300 bg-yellow-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border p-4 cursor-pointer transition-colors ${filterType === 'expiring' ? 'border-purple-300 bg-purple-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
                <div className="flex items-center justify-between">
                  <div>
