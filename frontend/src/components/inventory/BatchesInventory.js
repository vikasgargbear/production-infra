      ...
      <div className="px-4 py-3">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${statusFilter === 'good'
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${statusFilter === 'expiring_soon'
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${statusFilter === 'expired'
                ? 'bg-red-600 text-white'
                : 'bg-white text-gray-700 border border-gray-200 hover:bg-gray-50'
              }`}
          >
                  ...
                  filteredBatches.map((batch) => (
                    <tr key={batch.batch_id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-2 px-2">
                        <span className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-[10px] font-medium ${batch.status === 'good'
