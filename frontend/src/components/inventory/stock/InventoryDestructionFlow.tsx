...
const InventoryDestructionFlow: React.FC<Props> = ({ open = true, onClose }) => {
  ...
  const load = useCallback(async () => {
    ...
    try { setContext((await canonicalControlledOperationsApi.destructionContext()).data); setCandidateId(''); setCertificateId(''); }
