    ...
    <main className="flex-1 overflow-auto p-5" data-testid="canonical-immutable-preview"><div className="mx-auto max-w-6xl space-y-4">
      ...
      {workspace === 'prepare' && <>
        <section className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          {!context && <div className="mt-5 flex justify-end"><button type="button" disabled className="min-h-11 rounded-lg bg-slate-300 px-6 font-medium text-white">Prepare immutable preview</button></div>}
        </section>
