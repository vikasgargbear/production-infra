...
/**
 * PaymentInvoiceAllocator
 * Used in Payment module to allocate payments to outstanding invoices.
 * NOT to be confused with global/modals/InvoiceSelector (generic invoice picker).
 */
const PaymentInvoiceAllocator: React.FC = () => {
  const {
    outstandingInvoices,
    selectedInvoices,
    setSelectedInvoices,
...
export default PaymentInvoiceAllocator;