...
${localStorage.getItem('company_name') || 'Your Company'}`
    ...
    const handleInputChange = (field: keyof EmailData) => (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.to ? 'border-red-300' : 'border-gray-300'
                                }`}
                        />
                        {errors.to && (
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.cc ? 'border-red-300' : 'border-gray-300'
                                }`}
                        />
                        {errors.cc && (
                            <p className="mt-1 text-sm text-red-600 flex items-center">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.bcc ? 'border-red-300' : 'border-gray-300'
                                }`}
                        />
                        {errors.bcc && (
                            <p className="mt-1 text-sm text-red-600 flex items-center">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.subject ? 'border-red-300' : 'border-gray-300'
                                }`}
                        />
                        {errors.subject && (
                            <p className="mt-1 text-sm text-red-600 flex items-center">
