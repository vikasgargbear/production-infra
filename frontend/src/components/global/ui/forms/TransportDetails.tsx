...
interface TransportDetailsProps {
  ...
  onChange?: (field: keyof TransportDetailsData, value: string) => void;
  readOnly?: boolean;
  showTitle?: boolean;
}
...
const TransportDetails: React.FC<TransportDetailsProps> = ({ 
  ...
  const handleFieldChange = (field: keyof TransportDetailsData, value: string) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleFieldChange('vehicle_no', e.target.value)}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleFieldChange('dispatch_date', e.target.value)}
            readOnly={readOnly}
            disabled={readOnly}
            className={`
              w-full px-2 py-1.5 text-sm border border-gray-300 rounded
