        ...
        <div>
          ...
          {readOnly ? (
            ...
            <Select
              ...
              onChange={(value) => handleChange('payment_mode', String(value))}
        ...
        <div>
          ...
          {readOnly ? (
            ...
            <Select
              ...
              onChange={(value) => handleChange('payment_status', String(value))}
          ...
          <div>
            ...
            {readOnly ? (
              ...
              <Select
                ...
                onChange={(value) => handleChange('credit_terms', String(value))}
                options={creditTerms}
                size="sm"
              />
            )}
