...
import { Upload, FileText, Sparkles, CheckCircle, X, Loader2 } from 'lucide-react';
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex-1">
          ...
          <div
            ...
            onDrop={handleDrop}
            className={`relative border-2 border-dashed rounded-lg p-6 text-center transition-all cursor-pointer hover:bg-white/50 ${
              isDragging ? 'border-purple-400 bg-purple-50' : 'border-gray-300 bg-white/30'
            }`}
          >
            <input
              type="file"
