      ...
      <div className="text-center animate-fade-in">
        ...
        <div className="relative mb-6">
          ...
          <div className={`${sizeClasses[size]} mx-auto bg-gradient-to-br from-pharma-orange-600 to-red-600 rounded-2xl flex items-center justify-center shadow-pharma animate-pulse-slow`}>
            <Package className={`${iconSize[size]} text-white`} />
          </div>
...
export const InlineSpinner: React.FC<InlineSpinnerProps> = ({ size = "sm", message }) => {
  const spinnerSizes: Record<InlineSpinnerSize, string> = {
    xs: "w-3 h-3",
    sm: "w-4 h-4", 
    md: "w-5 h-5",
    lg: "w-6 h-6"
