...
const ReportsHub: React.FC<ReportsHubProps> = ({ open = true, onClose, initialSubpage, onSubpageChange }) => {
  ...
  const reportModules: ReportModule[] = [
    ...
    },
    {
      ...
      label: 'Customers · Soon',
      fullLabel: 'Customer Insights · Coming soon',
      description: 'Coming soon: canonical customer projection required',
      icon: Users,
      color: 'indigo',
    ...
    // Procurement & Supply Chain
    {
      ...
      label: 'Purchase · Soon',
      fullLabel: 'Purchase Analytics · Coming soon',
      description: 'Coming soon: posted supplier-invoice projection required',
      icon: ShoppingCart,
      color: 'green',
    ...
    // Inventory & Operations
    {
      ...
      fullLabel: 'Inventory Analytics · Coming soon',
      description: 'Coming soon: organization-wide stock projection required',
      icon: Package,
      color: 'purple',
    ...
    },
    {
      ...
      label: 'Products · Soon',
      fullLabel: 'Product Performance · Coming soon',
      description: 'Coming soon: reviewed product profitability projection required',
      icon: PieChart,
      color: 'amber',
    ...
    // Financial Reports
    {
      ...
      label: 'Financial · Soon',
      fullLabel: 'Financial Overview · Coming soon',
      description: 'Coming soon: reviewed management-financial projection required',
      icon: DollarSign,
      color: 'emerald',
    ...
    },
    {
      id: 'ledger-analytics',
      label: 'Ledger · Soon',
      fullLabel: 'Ledger Analytics · Coming soon',
      description: 'Coming soon: reviewed cross-ledger projection required',
      icon: BookOpen,
      color: 'teal',
    ...
    },
    {
      id: 'profit-loss',
      label: 'P&L · Soon',
      fullLabel: 'Profit & Loss Statement · Coming soon',
      description: 'Coming soon: reviewed statutory account mapping required',
      icon: Calculator,
      color: 'rose',
