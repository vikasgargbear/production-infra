 ...
 */
const BulkUploadInline = ({ onProductsUploaded }) => {
    ...
    try {
      ...
      reader.onload = (e) => {
        try {
          ...
          const validPackTypes = ['STRIP', 'BOX', 'BOTTLE', 'VIAL', 'TUBE', 'SACHET', 'INJECTION', 'AMPOULE'];
              ...
              if (value !== undefined && value !== '') {
                switch (col.field) {
                  ...
                  case 'pack_type':
                    ...
                    const packType = value?.toString().toUpperCase().trim();
                  ...
                  case 'schedule_type':
                    ...
                    const schedule = value?.toString().toUpperCase().trim();
                    const validSchedules = ['OTC', 'H', 'H1', 'X', 'G', 'J'];
                  ...
                  case 'storage_condition':
                    ...
                    const storage = value?.toString().toLowerCase().trim();
                    const storageMap = {
