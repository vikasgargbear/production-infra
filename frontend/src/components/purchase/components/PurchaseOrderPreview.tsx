...
const PurchaseOrderPreview: React.FC<PurchaseOrderPreviewProps> = ({ purchaseOrder }) => {
          ...
          <div className="mt-6 grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {(purchaseOrder.freight_charges || 0) > 0 && (
                  <div className="flex justify-between py-2">
                    <span className="text-gray-600">Freight Charges</span>
                    <span className="font-medium">{formatCurrency(purchaseOrder.freight_charges || 0)}</span>
                  </div>
                )}
                {(purchaseOrder.insurance_charges || 0) > 0 && (
                  <div className="flex justify-between py-2">
                    <span className="text-gray-600">Insurance Charges</span>
                    <span className="font-medium">{formatCurrency(purchaseOrder.insurance_charges || 0)}</span>
                  </div>
                )}
                {(purchaseOrder.other_charges || 0) > 0 && (
                  <div className="flex justify-between py-2">
                    <span className="text-gray-600">Other Charges</span>
                    <span className="font-medium">{formatCurrency(purchaseOrder.other_charges || 0)}</span>
                  </div>
                )}
                {(purchaseOrder.round_off || 0) !== 0 && (
                  <div className="flex justify-between py-2">
                    <span className="text-gray-600">Round Off</span>
                    <span className="font-medium">{formatCurrency(purchaseOrder.round_off || 0)}</span>
                  </div>
                )}
