...
import { X, Search, FileText, Truck, ShoppingCart, Calendar } from 'lucide-react';
import { ordersApi, challansApi, salesOrdersAPI } from '../../../services/api';

const ImportDocumentModal = ({ isOpen, onClose, onImport }) => {
  const [documentType, setDocumentType] = useState('sales-order');
