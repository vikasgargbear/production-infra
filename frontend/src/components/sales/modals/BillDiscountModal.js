...
const BillDiscountModal = ({ isOpen, onClose, currentDiscount = 0, billAmount = 0, onApply }) => {
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2 px-4 rounded border ${
