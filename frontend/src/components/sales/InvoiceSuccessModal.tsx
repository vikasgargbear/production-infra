...
import { CheckCircle, X, Printer, Download, Send, Copy, Sparkles } from 'lucide-react';
                ...
                <div className="px-6 py-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className={`w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl transition-colors font-medium ${copied
