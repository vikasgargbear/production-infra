                        ...
                        <div className="space-y-1">
                            ...
                            {(challan.freight_charges ?? 0) > 0 && (
                                <div className="text-xs mt-2 pt-2 border-t border-yellow-200">
                                    ...
                                    <p className="text-gray-900 font-bold">{formatCurrency(challan.freight_charges || 0)}</p>
                                </div>
                            )}
                            ...
                            <div className="p-3 space-y-1">
                                ...
                                {(challan.freight_charges ?? 0) > 0 && (
                                    <div className="flex justify-between text-xs">
                                        ...
                                        <span className="font-medium">{formatCurrency(challan.freight_charges || 0)}</span>
                                    </div>
                                )}
