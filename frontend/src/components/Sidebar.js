...
const Sidebar = ({ activeTab, onTabChange }) => {
  ...
  return (
    <>
      ...
      {/* Mobile sidebar */}
      <div className={`fixed top-0 left-0 h-screen bg-red-600 z-50 shadow-xl transition-all duration-300 transform md:hidden ${mobileOpen ? 'translate-x-0' : '-translate-x-full'} w-64`}>
      ...
      {/* Desktop sidebar */}
      <div className={`hidden md:block h-screen bg-red-600 shadow-sm transition-all duration-300 fixed top-0 left-0 z-10 ${collapsed ? 'w-16' : 'w-64'}`}>
        <div className="flex flex-col h-full">
          <SidebarHeader />
          <div className="p-3 overflow-y-auto flex-1">
            <MainNavigation />
