...
export default defineConfig({
  ...
  projects: [
    {
      name: 'desktop-chrome',
      testMatch: /(?:canonical-read-surfaces|customer-receipt-operator|google-only-login|live-production-smoke|live-canonical-core-api|live-canonical-core-ui|live-canonical-stock-transfer|live-sales-chain-api|live-sales-chain-ui|live-two-user-approval|live-history-gst-readonly|live-stock-hub-ui)\.spec\.ts/,
      use: {
