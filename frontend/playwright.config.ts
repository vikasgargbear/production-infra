...
export default defineConfig({
  ...
  projects: [
    {
      name: 'desktop-chrome',
      testMatch: /(?:live-production-smoke|live-canonical-core-api|live-canonical-core-ui|live-sales-chain-api|live-sales-chain-ui|live-two-user-approval|live-history-gst-readonly|live-stock-hub-ui)\.spec\.ts/,
      use: {
