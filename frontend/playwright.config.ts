...
export default defineConfig({
  ...
  projects: [
    {
      name: 'desktop-chrome',
      testMatch: /(?:live-production-smoke|live-canonical-core-api|live-canonical-core-ui|live-sales-chain-api|live-sales-chain-ui|live-two-user-approval)\.spec\.ts/,
      use: {
