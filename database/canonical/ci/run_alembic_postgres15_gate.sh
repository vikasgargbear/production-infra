...
PYTHONPATH=backend \
  python backend/tests/postgres/check_permission_argument_scope.py
...
PYTHONPATH=backend \
  python backend/tests/postgres/check_sales_invoice_archival_snapshots.py
PYTHONPATH=backend \
...
PYTHONPATH=backend \
  python backend/tests/postgres/check_canonical_financial_reporting_runtime_role.py
PYTHONPATH=backend \
...
PYTHONPATH=backend \
  python backend/tests/postgres/check_historical_product_inventory_cutover_runtime_role.py
PYTHONPATH=backend \
...
PYTHONPATH=backend \
  python backend/tests/postgres/check_product_reference_masters_runtime_role.py
PYTHONPATH=backend \
