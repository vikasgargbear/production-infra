...
-- =============================================
-- 1. SALES INVENTORY OWNERSHIP
-- =============================================
-- Invoice creation and cancellation mutate inventory in InvoiceService inside
-- the same transaction as the invoice. Do not add invoice stock triggers here:
-- a second mutation owner double-applies balances and duplicates movements.
