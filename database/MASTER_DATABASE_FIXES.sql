...
-- =============================================
-- SECTION 25: CUSTOMER OUTSTANDING TRIGGERS
-- =============================================
-- Purpose: Automatically populate customer_outstanding from invoices
-- This ensures every invoice has a corresponding outstanding record

-- Function to create customer_outstanding record when invoice is created
...
SELECT 'Customer outstanding triggers created' as status;

-- =============================================
-- SECTION 26: PURCHASE ENTRY TRIGGERS
-- =============================================
-- Date: 2025-09-01
-- Purpose: Add triggers for automatic batch creation and inventory updates on purchase entry
-- =============================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE '✅ Added batch_number to purchase_order_items';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE '✅ Added expiry_date to purchase_order_items';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE '✅ Added selling_price to purchase_order_items';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE '✅ Added mrp to purchase_order_items';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE '✅ Added free_quantity to purchase_order_items';
    END IF;
    
    RAISE NOTICE '✅ SECTION 26: Purchase order items columns verified';
END $$;

-- Copy the trigger functions from 04a_direct_purchase_triggers.sql
-- They will be inserted here via the full SQL content
